package com.PSC.framework.list;
...
public class ListHelper extends GenericHelper  {
	...
	public static void goToDetailProspectScreen(String Name, By tableXpath ) {
		...
		//.System.out.println(" INSIDE goToDetailProspectScreen");
	...
	public void redirectionToClientListing() {
		
		
		driver.navigate().to("https://wrkoutadminqa.azurewebsites.net/Lead/ProspectList");
